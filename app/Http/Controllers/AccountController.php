    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($accounts)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'AccountController@edit\',[$id])}}" data-container=".account_model" class="btn btn-xs btn-primary-boxity btn-modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                ...
                ->editColumn('action', function ($row) {
                    ...
                    if (auth()->user()->can('edit_account_transaction')) {
                        if ($row->sub_type == 'fund_transfer' || $row->sub_type == 'deposit' || $row->sub_type == 'opening_balance') {
                            $action .= ' <button type="button" class="btn btn-primary-boxity btn-xs btn-modal" data-container="#edit_account_transaction" data-href="' . action('AccountController@editAccountTransaction', [$row->id]) . '"><i class="fa fa-edit"></i> ' . __('messages.edit') . '</button>';
                        }
                    }
