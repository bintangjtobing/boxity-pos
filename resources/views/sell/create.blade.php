...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		...
		<div class="col-sm-12 text-center">
			<button type="button" id="submit-sell" class="btn btn-primary-boxity btn-block btn-lg">@lang('messages.save')</button>
			<button type="button" id="save-and-print" class="btn btn-success btn-block btn-lg">@lang('lang_v1.save_and_print')</button>
		</div>
	</div>
