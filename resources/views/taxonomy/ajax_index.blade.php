...
@endphp
@can('category.create')
	<button type="button" class="btn btn-sm pull-right btn-primary-boxity btn-modal" data-href="{{action('TaxonomyController@create')}}?type={{$category_type}}" data-container=".category_modal">
