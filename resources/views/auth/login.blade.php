...
@section('content')
<div class="login-form col-md-12 col-xs-12 right-col-content" style="padding-top: 30%;">
    <p class="form-header text-white" style="font-size: 24px;font-weight: 900;text-transform: uppercase;">
        @lang('lang_v1.login')</p>
    <form method="POST" action="{{ route('login') }}" id="login-form">
        ...
        <div class="form-group">
            <button type="submit"
                class="btn btn-primary-boxity btn-rounded btn-block btn-lg btn-login">@lang('lang_v1.login')</button>
            @if(config('app.env') != 'demo')
            <a href="{{ route('password.request') }}" class="pull-right"
                style="font-size: 12px; font-weight: 400;margin-top: 1rem;">
...
<div class="col-md-12 col-xs-12" style="padding-bottom: 30px;">
    @component('components.widget', ['class' => 'box-primary-boxity', 'header' => '<h4 class="text-center">Demo Shops
