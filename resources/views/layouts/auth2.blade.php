...
<body>
    ...
    <div class="container-fluid">
        <div class="row eq-height-row">
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col">
                <div class="left-col-content login-header">
                    <div style="margin-top: 65%;">
                        <a href="/">
                            @if(file_exists(public_path('img/lunar-logo.png')))
                            <img src="/img/lunar-logo.png" class="img-rounded" alt="Logo" width="350">
                            @else
                            {{ config('app.name', 'LunarPOS by Boxity') }}
                            @endif
                        </a>
                        <br />
            ...
            <div class="col-md-7 col-sm-7 col-xs-12 right-col eq-height-col" style="background-color: #95370B;">
                <div class="row">
                    ...
                    <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                        ...
                        <a href="{{ route('business.getRegister') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif"
                            class="btn btn-secondary-boxity btn-rounded"><b>{{ __('business.not_yet_registered')}}</b>
